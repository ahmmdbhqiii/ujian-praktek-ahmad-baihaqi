  ...
  <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9f9f9; padding: 25px; border: 1px solid #ddd; border-radius: 8px; line-height: 1.6;">
      ...
      <p style="font-size: 14px; color: #444; margin-bottom: 15px;">
        Saya adalah seorang siswa atau developer pemula yang sedang belajar pemrograman web, khususnya menggunakan framework Laravel. Project ini dibuat sebagai bagian dari latihan praktik untuk memahami konsep dasar database, migrasi, dan Eloquent ORM.
      </p>
